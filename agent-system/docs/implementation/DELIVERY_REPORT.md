...
已同步至 `shizuguilai/survive` 的 `work/agent-cognition-20260924` 分支，实施提交 `3f34492c01b2739023ff1160c99c9ffcbec843b6`。完整源树与本地暂存树一致；main 保持原基线。验收证据在该提交的 `agent-system/evidence/`，正式发布仍为未发布。
