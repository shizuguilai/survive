...
当前试玩已加入**营地目标、木材/石料/浆果采集、饥饿、生命和疲劳**。右上角「布置营地目标」发布公告，居民需亲自读到并自主接受；原先的问候目标和缺失行动反馈已修正。详见[本轮范围与验收](agent-system/docs/implementation/CAMP_PROGRESS.md)。
...
| 本次修复版本 | 已发布；营地版托管源码 `feee88ffca3b02946a8a66b3528fb5ce2810eb3f`，运行时配置 revision 3 |
| 本轮营地真实模型 | 45次独立请求；亲读公告、自主接受、实际采集令目标进度+1；8821次冻结检查无违规，非完整长期营地验收 |
